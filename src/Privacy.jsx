...
function Privacy() {
  return (
    <div className="p-5 h-[90%] overflow-y-scroll">
      <p className="text-sm">
        At <span className=" font-bold">RummyBestApps</span>, accessible from <span className=" font-bold">RummyBestApps</span>, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        <span className=" font-bold">RummyBestApps</span> and how we use it. <br />
        <br /> If you have additional questions or require more information
        about our Privacy Policy, do not hesitate to contact us.
        <br />
        <br /> This Privacy Policy applies only to our online activities and is
        valid for visitors to our website with regards to the information that
        they shared and/or collect in Rummtbestapps.Com. This policy is not
        ...
        promotional purposes Send you emails
        <br /> Find and prevent fraud
        <br />
        <br /> Log Files
        <br />
        <br /> <span className=" font-bold">RummyBestApps</span> follows a standard procedure of using log files.
        ...
        the advertising partners of <span className=" font-bold">RummyBestApps</span>.
        <br />
        ...
        advertisements and links that appear on Rummtbestapps.Com, which are
        sent directly to users' browser. They automatically receive your IP
        address when this occurs. These technologies are used to measure the
        effectiveness of their advertising campaigns and/or to personalize the
        advertising content that you see on websites that you visit.
        <br />
        <br /> Note that <span className=" font-bold">RummyBestApps</span> has no access to or control over these
        cookies that are used by third-party advertisers.
        <br />
        <br /> Third Party Privacy Policies
        <br />
        <br />
        <span className=" font-bold">RummyBestApps</span>'s Privacy Policy does not apply to other advertisers or
        ...
        <br />
        <br /> Under the CCPA, among other rights, California consumers have the
        right to:
        <br />
        <br /> Request that a business that collects a consumer's personal data
        ...
        <br />
        <br /> Request that a business that sells a consumer's personal data,
        ...
        conditions.
        <br />
        <br /> The right to object to processing – You have the right to object
        ...
        <br />
        <br /> <span className=" font-bold">RummyBestApps</span> does not knowingly collect any Personal
        ...
        <span className="text-blue-600">earningplatform003@gmail.com</span>
        <br />
        <br />
        Note :- If You Have an Application Company and You Also Want to Promote
        Your Application, Then You Can Contact us on This Email Given Above and
        You Can Get Your Application Advertised on Our Website. Queries :- all
        rummy app ।
      </p>
    </div>
  );
